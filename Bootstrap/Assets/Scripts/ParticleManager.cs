...
public class ParticleManager : SystemBase {
	Mesh particleMesh;
	...
	{
		ParticleData data = EntityManager.GetSharedComponentData<ParticleData>(0);
		particleMesh = data.particleMesh;
		particleMaterial = data.particleMaterial;
		spinRate = data.spinRate;
		upwardSpeed = data.upwardSpeed;
